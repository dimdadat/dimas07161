...
public class Dimas07161_PelangganGUI {
    ...
    public Dimas07161_PelangganGUI(){
        ...
        labelemail.setBounds(470, 480, 150, 30);
        LogReg.add(labelemail);
        
        textemail = new JTextField();
        textemail.setBounds(470, 510, 150, 30);
        ...
        check.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ae) {
                    try {
                        allobj.pelangganController.login(textlogin.getText(), passwordlogin.getText());
                        int loggedUser = allobj.pelangganController.pelanggan().getId();
                        String nama = allobj.pelangganController.pelanggan().getNama();
                        JOptionPane.showMessageDialog(null, "selamat datang " + nama, "information", JOptionPane.INFORMATION_MESSAGE);
                        Dimas07161_TransaksiGUI tran = new Dimas07161_TransaksiGUI(loggedUser);
                        LogReg.dispose();
        ...
        reg.addActionListener(new ActionListener() {            
            public void actionPerformed(ActionEvent ae){
                ...
                allobj.pelangganController.insert(nama, pass, alamat, noktp, notelp, tgllahir, email);
